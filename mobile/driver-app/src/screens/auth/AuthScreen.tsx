...
export const AuthScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.input} value={phone} onChangeText={setPhone} placeholder={ru.auth.phonePlaceholder} keyboardType="phone-pad" maxLength={13} />
      <TouchableOpacity style={[styles.button, !isValidPhone(phone) && styles.buttonDisabled]} onPress={handleSubmit} disabled={!isValidPhone(phone) || register.isPending}>
