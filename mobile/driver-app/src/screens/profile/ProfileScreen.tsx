  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.menuItem}>
        <Text style={styles.menuText}>{ru.profile.documents}</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.menuItem}>
        <Text style={styles.menuText}>{ru.profile.vehicle}</Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  phone: { fontSize: 14, color: colors.textSecondary, marginTop: 4, marginBottom: 32 },
  menuItem: { width: '90%', backgroundColor: colors.surface, borderRadius: 12, padding: 16, marginBottom: 8 },
  menuText: { fontSize: 16, color: colors.text },
  logoutButton: { marginTop: 24, padding: 16 },
